 ...
 */
export function graphql(
	source: "fragment ProductListItem on Product { id name slug pricing { priceRange { start { gross { amount currency } } stop { gross { amount currency } } } } weight { unit value } attributes { attribute { slug name } values { slug name } } category { id name } thumbnail(size: 1024, format: WEBP) { url alt } }",
